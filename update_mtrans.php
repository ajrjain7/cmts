...
function show_last_mtrans($trans_id)
{
	try{			if($trans_id=="")return;
			...
			$firesql="select * from m_trans_detail where trans_id=".$trans_id." order by sys_creation_dated";
...
<?php show_last_mtrans($_GET['trans_id']);?>
</div>
